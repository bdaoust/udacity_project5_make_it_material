...
public class ArticleDetailActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setEnterSharedElementCallback(customSharedElementCallback);
    ...
    public void finishAfterTransition() {
        ...
        data.putExtra(EXTRA_CURRENT_POSITION, mPager.getCurrentItem());
    ...
    private class CustomSharedElementCallback extends SharedElementCallback {
        ...
        public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
            if(mIsReturning){
                ...
                sharedElement = mCurrentArticleDetailFragment.getArticlePhoto();

                if(mStartingPosition != mPager.getCurrentItem()){
                    names.clear();
